 ...
 * Principio SRP: contiene únicamente lógica de negocio; no accede directamente a la BD.
 * Principio DIP: recibe sus dependencias por constructor (inyección por constructor).
 */
@Service
public class ProductoServiceImpl implements ProductoService {
    ...
    public ProductoResponseDTO buscarPorId(Long id) {
        ...
        log.debug("Producto con id={} recuperado correctamente", id);
    ...
    public List<ProductoResponseDTO> listarActivos() {
        ...
        List<ProductoResponseDTO> lista = repo.findByActivoTrue()
                ...
                .toList();
        log.info("Total de productos activos recuperados: {}", lista.size());
        return lista;
    }
    ...
    public void eliminar(Long id) {
        ...
        buscarPorId(id); // lanza RecursoNoEncontradoException si no existe
        repo.deleteById(id);
